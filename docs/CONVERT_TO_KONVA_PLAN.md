...
- [ ] Select/move single & multi
- [ ] Resize/rotate with handles (Transformer)
- [ ] Z-order change (bring front/back)
- [ ] Text edit inline
- [ ] Shapes: rect, ellipse, line, arrow, free draw (optional Path)
- [ ] Style: stroke, fill, strokeWidth, opacity
- [ ] Undo/redo for all ops
- [ ] Export PNG/JPEG
- [ ] Import background image
- [ ] Serialization (session save/load)
- [ ] Zoom/pan (if present in Fabric version)
- [ ] Keyboard shortcuts (delete, ctrl+c/v, ctrl+z/y)
