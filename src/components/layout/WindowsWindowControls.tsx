...
export const WindowsWindowControls: React.FC = () => {
    ...
    return (
        <div className="flex items-center px-3 h-7 select-none drag bg-transparent">
            {/* Title / Drag Area */}
            <div className="flex-1 text-center text-[10px] font-medium text-foreground-muted tracking-wider uppercase flex items-center gap-1.5">
            ...
            <div className="flex items-center gap-1 no-drag">
                <button
                    ...
                    className="p-1 hover:bg-[var(--color-glass-button)] rounded-md transition-colors text-foreground-muted hover:text-foreground"
                    title="Minimize"
                >
                ...
                >
                    {isMaximized ? (
                        <Copy className="w-3 h-3 rotate-180" /> // Approximate restore icon
                    ) : (
                ...
                <button
                    onClick={handleClose}
                    className="p-1 hover:bg-red-500/80 rounded-md transition-colors text-foreground-muted hover:text-white group"
                    title="Close"
                >
