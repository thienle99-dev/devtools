...
const JsonFormatter = React.lazy(() => import('@tools/json/JsonFormatter').then(m => ({ default: m.JsonFormatter })));
const JsonYamlConverter = React.lazy(() => import('@tools/converters/JsonYamlConverter').then(m => ({ default: m.JsonYamlConverter })));
const Base64Converter = React.lazy(() => import('@tools/converters/Base64Converter').then(m => ({ default: m.Base64Converter })));
const NumberBaseConverter = React.lazy(() => import('@tools/converters/NumberBaseConverter').then(m => ({ default: m.NumberBaseConverter })));
const CaseConverter = React.lazy(() => import('@tools/converters/CaseConverter').then(m => ({ default: m.CaseConverter })));
const JsonXmlConverter = React.lazy(() => import('@tools/converters/JsonXmlConverter').then(m => ({ default: m.JsonXmlConverter })));
const MarkdownHtmlConverter = React.lazy(() => import('@tools/converters/MarkdownHtmlConverter').then(m => ({ default: m.MarkdownHtmlConverter })));
...
const PdfPageExtractor = React.lazy(() => import('@tools/pdf/PdfPageExtractor').then(m => ({ default: m.PdfPageExtractor })));
const PdfPageRotator = React.lazy(() => import('@tools/pdf/PdfPageRotator').then(m => ({ default: m.PdfPageRotator })));
const PdfMetadata = React.lazy(() => import('@tools/pdf/PdfMetadata').then(m => ({ default: m.PdfMetadata })));
const PdfBase64 = React.lazy(() => import('@tools/pdf/PdfBase64').then(m => ({ default: m.PdfBase64 })));
const PdfCompressor = React.lazy(() => import('@tools/pdf/PdfCompressor').then(m => ({ default: m.PdfCompressor })));
const PdfValidator = React.lazy(() => import('@tools/pdf/PdfValidator').then(m => ({ default: m.PdfValidator })));
const PdfPageReorder = React.lazy(() => import('@tools/pdf/PdfPageReorder').then(m => ({ default: m.PdfPageReorder })));
const PdfWatermarker = React.lazy(() => import('@tools/pdf/PdfWatermarker').then(m => ({ default: m.PdfWatermarker })));
const PdfPageNumbering = React.lazy(() => import('@tools/pdf/PdfPageNumbering').then(m => ({ default: m.PdfPageNumbering })));
const HtmlToPdf = React.lazy(() => import('@tools/pdf/HtmlToPdf').then(m => ({ default: m.HtmlToPdf })));
const MarkdownToPdf = React.lazy(() => import('@tools/pdf/MarkdownToPdf').then(m => ({ default: m.MarkdownToPdf })));
const PdfMetadataRemover = React.lazy(() => import('@tools/pdf/PdfMetadataRemover').then(m => ({ default: m.PdfMetadataRemover })));

const HashGenerator = React.lazy(() => import('@tools/crypto/HashGenerator').then(m => ({ default: m.HashGenerator })));
const UuidGenerator = React.lazy(() => import('@tools/crypto/UuidGenerator').then(m => ({ default: m.UuidGenerator })));
const TokenGenerator = React.lazy(() => import('@tools/crypto/TokenGenerator').then(m => ({ default: m.TokenGenerator })));
const HmacGenerator = React.lazy(() => import('@tools/crypto/HmacGenerator').then(m => ({ default: m.HmacGenerator })));
const AesEncryptor = React.lazy(() => import('@tools/crypto/AesEncryptor').then(m => ({ default: m.AesEncryptor })));
const BcryptGenerator = React.lazy(() => import('@tools/crypto/BcryptGenerator').then(m => ({ default: m.BcryptGenerator })));

const UrlEncoder = React.lazy(() => import('@tools/web/UrlEncoder').then(m => ({ default: m.UrlEncoder })));
const HtmlEntityEncoder = React.lazy(() => import('@tools/web/HtmlEntityEncoder').then(m => ({ default: m.HtmlEntityEncoder })));
const UrlParser = React.lazy(() => import('@tools/web/UrlParser').then(m => ({ default: m.UrlParser })));
const BasicAuthGenerator = React.lazy(() => import('@tools/web/BasicAuthGenerator').then(m => ({ default: m.BasicAuthGenerator })));
const SlugGenerator = React.lazy(() => import('@tools/web/SlugGenerator').then(m => ({ default: m.SlugGenerator })));
const UserAgentParser = React.lazy(() => import('@tools/web/UserAgentParser').then(m => ({ default: m.UserAgentParser })));
const JwtParser = React.lazy(() => import('@tools/web/JwtParser').then(m => ({ default: m.JwtParser })));
const HttpStatusCode = React.lazy(() => import('@tools/web/HttpStatusCode').then(m => ({ default: m.HttpStatusCode })));
const JsonDiff = React.lazy(() => import('@tools/web/JsonDiff').then(m => ({ default: m.JsonDiff })));

const Ipv4SubnetCalculator = React.lazy(() => import('@tools/network/Ipv4SubnetCalculator').then(m => ({ default: m.Ipv4SubnetCalculator })));
const Ipv4Converter = React.lazy(() => import('@tools/network/Ipv4Converter').then(m => ({ default: m.Ipv4Converter })));
const MacGenerator = React.lazy(() => import('@tools/network/MacGenerator').then(m => ({ default: m.MacGenerator })));
const MacLookup = React.lazy(() => import('@tools/network/MacLookup').then(m => ({ default: m.MacLookup })));

const SqlFormatter = React.lazy(() => import('@tools/development/SqlFormatter').then(m => ({ default: m.SqlFormatter })));
const JsonToCsv = React.lazy(() => import('@tools/development/JsonToCsv').then(m => ({ default: m.JsonToCsv })));
const XmlFormatter = React.lazy(() => import('@tools/development/XmlFormatter').then(m => ({ default: m.XmlFormatter })));
const YamlFormatter = React.lazy(() => import('@tools/development/YamlFormatter').then(m => ({ default: m.YamlFormatter })));
const RegexTester = React.lazy(() => import('@tools/development/RegexTester').then(m => ({ default: m.RegexTester })));
const CrontabGenerator = React.lazy(() => import('@tools/development/CrontabGenerator').then(m => ({ default: m.CrontabGenerator })));
const ChmodCalculator = React.lazy(() => import('@tools/development/ChmodCalculator').then(m => ({ default: m.ChmodCalculator })));
const DockerConverter = React.lazy(() => import('@tools/development/DockerConverter').then(m => ({ default: m.DockerConverter })));
const ClipboardManager = React.lazy(() => import('@tools/utilities/ClipboardManager').then(m => ({ default: m.ClipboardManager })));
const StatsMonitor = React.lazy(() => import('@tools/utilities/stats-monitor/StatsMonitor').then(m => ({ default: m.default })));
