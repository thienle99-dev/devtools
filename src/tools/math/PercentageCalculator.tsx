            ...
            <div className="glass-panel p-6 space-y-8">
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="text-sm font-semibold text-white/70">What is...</h3>
                    </div>
                ...
                <div className="space-y-12">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4 group">
                        <div className="flex items-center gap-3">
                            <span className="text-sm text-white/50">What is</span>
                            <div className="w-24">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4 group">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm text-white/50">is what % of</span>
                            <div className="w-32">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4 group">
                        <div className="flex items-center gap-3">
                            <span className="text-sm text-white/50">Percentage increase from</span>
                            <div className="w-24">
                        ...
                        <div className="flex-1 w-full md:w-auto h-12 flex items-center justify-center rounded-xl bg-violet-500/10 border border-violet-500/20 px-6">
                            <span className={`text-2xl font-bold ${results.r3 !== null && results.r3 < 0 ? 'text-rose-400' : 'text-white'}`}>
