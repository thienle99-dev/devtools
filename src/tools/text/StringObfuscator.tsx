...
type ObfuscationMethod = 'rot13' | 'base64' | 'hex' | 'binary' | 'reverse';
...
export const StringObfuscator: React.FC = () => {
    ...
    const obfuscate = (str: string, m: ObfuscationMethod): string => {
        if (!str) return '';
        switch (m) {
            case 'rot13':
    ...
    const deobfuscate = (str: string, m: ObfuscationMethod): string => {
        if (!str) return '';
        switch (m) {
            case 'rot13':
