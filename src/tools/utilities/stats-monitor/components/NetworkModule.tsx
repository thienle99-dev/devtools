    ...
    <div className="bg-white/5 p-4 rounded-xl border border-white/10 flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-medium text-white/90">Network</h3>
            <p className="text-xs text-white/50">{activeInterface?.ifaceName || activeStats?.iface || 'Unknown'}</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <div className="h-16 w-full bg-black/20 rounded-lg overflow-hidden relative">
            ...
            />
             <div className="absolute bottom-1 right-1 text-[10px] text-white/30">Down</div>
        </div>
        ...
        <div className="h-16 w-full bg-black/20 rounded-lg overflow-hidden relative">
            ...
            />
            <div className="absolute bottom-1 right-1 text-[10px] text-white/30">Up</div>
        </div>
      </div>
