                ...
                <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 min-h-0">
                    ...
                    <div className="lg:col-span-8 flex flex-col gap-4 min-h-0">
                        <div className="relative flex-1 bg-black rounded-3xl border border-border-glass overflow-hidden group shadow-2xl">
                            ...
                            {/* Recording Indicator */}
                            {isRecording && (
                                <div className="absolute top-6 right-6 flex items-center gap-2 px-3 py-1.5 bg-rose-500/80 backdrop-blur-md rounded-full text-white text-[10px] font-black uppercase tracking-widest shadow-lg">
