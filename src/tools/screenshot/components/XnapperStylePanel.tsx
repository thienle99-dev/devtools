                ...
                <TabsContent value="design" className="space-y-5 pt-2 mt-0 border-none outline-none overflow-y-auto px-5 pb-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-4 gap-2 pl-10">
                            {SOCIAL_PRESETS.map((preset) => (
                                <button
                                    key={preset.id}
                                    onClick={() => {
                                        // TODO: Implement custom resize to social media dimensions
                                        console.log(`Resize to ${preset.width}×${preset.height} for ${preset.label}`);
                                    }}
                                    className="group relative px-2 py-3 text-[10px] font-bold rounded-xl bg-glass-panel hover:bg-green-500/10 hover:text-green-400 border border-border-glass hover:border-green-500/50 transition-all duration-200 text-foreground-secondary"
                                    title={`${preset.width}×${preset.height}`}
                                >
                                    <div className="mb-1">{preset.label}</div>
                                    <div className="text-[8px] text-foreground-muted group-hover:text-green-400/70">
                        ...
                        <button 
                            ...
                            onClick={() => {
                                // TODO: Implement custom dimension input
                                console.log('Open custom dimension dialog');
                            }}
                        >
                            + Custom Size...
                        </button>
